...
def persist_generation(
    ...
    *,
    ...
    """Persist provider output as an immutable article revision."""
    title = _extract_title(generated_markdown)
    storage.save_article_revision(
        user_id,
        article_id,
...
# Compatibility entry point for callers outside the API router.
...
def run_generation(
    *,
    ...
    try:
        ...
        return
    store.complete_job(user_id, job_id, result=result)
