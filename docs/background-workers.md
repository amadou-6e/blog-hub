...
process. API requests only enqueue jobs. Generation, inspection, regeneration, and
publishing continue independently of the FastAPI process that accepted the request.
